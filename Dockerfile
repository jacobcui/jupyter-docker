...
LABEL maintainer="Jacob CUI <jacobcui123@gmail.com>"
ARG NB_USER="jacob"
ARG NB_UID="1000"
ARG NB_GID="100"
...
# Create NB_USER wtih name jacob user with UID=1000 and in the 'users' group
...
# Install conda as jacob and check the md5 sum provided on the download site
